...
axs[0, 0].plot(POLSPEVP1_dr[:, k_pos], POLSPEVP1_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[0, 1].plot(POLSPEVP2_dr[:, k_pos], POLSPEVP2_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[1, 0].plot(POLSPEVP3_dr[:, k_pos], POLSPEVP3_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[1, 1].plot(POLSPEST_dr[:, k_pos], POLSPEST_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[0, 0].plot(POLSPELT_dr[:, k_pos], POLSPELT_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[0, 1].plot(HIVGRPCG_dr[:, k_pos], HIVGRPCG_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[1, 0].plot(HIVSUBCG_dr[:, k_pos], HIVSUBCG_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
axs[1, 1].plot(HIVSUBPOL_dr[:, k_pos], HIVSUBPOL_dr[:, fscore_kameris_pos], 'g--', label='kameris-svd')
...
# comparison between 'POLSPEVP1', 'POLSPEVP2', 'POLSPEVP3', 'POLSPEST' without dimentionality reduction
fig, axs = plt.subplots(2, 2)
axs[0, 0].plot(POLSPEVP1_dr[:, k_pos], POLSPEVP1_dr[:, nfeatures_kameris_pos], 'g--', label='kameris-svd')
...
axs[0, 0].set_title('POLSPEVP1')
axs[0, 1].plot(POLSPEVP2_dr[:, k_pos], POLSPEVP2_dr[:, nfeatures_kameris_pos], 'g--', label='kameris-svd')
...
axs[0, 1].set_title('POLSPEVP2')
axs[1, 0].plot(POLSPEVP3_dr[:, k_pos], POLSPEVP3_dr[:, nfeatures_kameris_pos], 'g--', label='kameris-svd')
...
axs[1, 0].set_title('POLSPEVP3')
axs[1, 1].plot(HIVSUBPOL_dr[:, k_pos], HIVSUBPOL_dr[:, nfeatures_kameris_pos], 'g--', label='kameris-svd')
